...
findViewById(R.id.btnAppAccess).setOnClickListener(v->startActivity(new Intent(this,AppAccessActivity.class)));        findViewById(R.id.btnSave).setOnClickListener(v->saveAll()); telegramOn.setOnCheckedChangeListener((buttonView,checked)->{Intent i=new Intent(this,com.hermes.jarvis.service.TelegramAgentService.class);if(checked){startForegroundService(i);}else{stopService(i);}});findViewById(R.id.btnWebTools).setOnClickListener(v->startActivity(new Intent(this,WebToolsActivity.class)));findViewById(R.id.btnPersona).setOnClickListener(v->startActivity(new Intent(this,PersonaActivity.class)));findViewById(R.id.btnTools).setOnClickListener(v->startActivity(new Intent(this,ToolsActivity.class)));findViewById(R.id.btnGithub).setOnClickListener(v->startActivity(new Intent(this,GitHubActivity.class)));findViewById(R.id.btnAccessibility).setOnClickListener(v->startActivity(new Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS)));findViewById(R.id.btnPairWa).setOnClickListener(v->pairWhatsApp());
        load();
    }
